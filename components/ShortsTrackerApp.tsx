...
import SmmBalanceBadge from "./SmmBalanceBadge";
      ...
      <header className="border-b border-gray-800 bg-gray-900/70 backdrop-blur">
        <div className="mx-auto flex max-w-7xl flex-col gap-3 px-4 py-5 sm:flex-row sm:items-center sm:justify-between">
          ...
          <div className="flex flex-col items-stretch gap-2 sm:flex-row sm:items-center">
            ...
            <SmmBalanceBadge enabledExternal={smmConfig?.enabled} />
            <a
              href="/orders"
              className="inline-flex items-center justify-center gap-1.5 rounded-lg bg-gray-800 px-4 py-2 text-xs font-semibold text-gray-200 ring-1 ring-gray-700 transition hover:ring-sky-500"
            >
              Orders
            </a>
